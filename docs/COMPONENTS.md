...
| ClaudeDesignButton | `src/components/ClaudeDesignButton.tsx` | **Removed from DesignStudio** — replaced by an inline "Copy Claude design prompt" clipboard button. File retained but no longer imported anywhere. |
